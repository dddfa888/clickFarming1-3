export default {
  ...
  "文件名称({})非法，不允许下载":
    "File name ({}) is invalid, download not allowed",
  "资源文件({})非法，不允许下载":
    "Resource file ({}) is invalid, download not allowed",
  ...
  当前账户金额小于减少金额:
    "The current account balance is less than the reduction amount",
  ...
  "今天下单次数已达到上限，无法继续下单":
    "Today's order limit has been reached, no more orders can be placed",
  未查到产品信息: "No product information found",
  订单不存在: "Order does not exist",
  "订单已支付，不可重复支付":
    "Order has already been paid, duplicate payment not allowed",
  操作失败: "Operation failed",
  资金密码不能为空: "Fund password cannot be empty",
  取款数额不能为空: "The withdrawal amount cannot be empty",
  "您尚未完成当天的订单数量，无法提现":
    "You have not completed the number of orders for today, withdrawal not allowed",
  团体: "Group",
  订单奖励: "Order reward",
  通知: "notice",
  全部: "all",
  ...
  您尚未完成当天的申请数量:
    "You haven't completed the number of applications for the day.",
  ...
  "地址未填写,请填写完整":
    "Address is not filled in, please fill in completely",
  ...
  您无法升级到低于当前级别的级别:
    "You cannot upgrade to a level lower than your current one",
  ...
  "已有提现订单,请勿重复申请":
    "There is already a withdrawal order, please do not apply again",
  "您尚未填写银行信息，请点击留言。":
    "You have not filled in your bank information, please click on the message board.",
  这里: "here",
  ...
  银行名不能为空: "Bank name cannot be empty",
  资金密码不能为空: "Capital password cannot be empty",
  已存在的用户名或电话号码: "Existing username or phone number",
  ...
  "已有提现订单,请勿重复申请":
    "There are already withdrawal orders, please do not apply again",
