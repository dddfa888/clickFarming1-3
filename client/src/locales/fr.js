export default {
  ...
  "取款数额格式错误，无法解析":
    "Erreur de format de numéro [{value}], ne peut pas être analysé",
  ...
  "文件名称({})非法，不允许下载":
    "Le nom du fichier ({}) n'est pas valide, le téléchargement n'est pas autorisé",
  "资源文件({})非法，不允许下载":
    "Le fichier de ressource ({}) n'est pas valide, le téléchargement n'est pas autorisé",
  ...
  当前账户金额小于减少金额:
    "Le solde du compte courant est inférieur au montant de la réduction",
  "有订单未完成，请先付款":
    "Il y a des commandes inachevées, s'il vous plaît payer d'abord",
  用户等级不存在: "Le niveau utilisateur n'existe pas",
  账户余额不足: "Le solde du compte est insuffisant",
  "今天下单次数已达到上限，无法继续下单":
    "La limite de commande d'aujourd'hui a été atteinte, plus de commandes ne peuvent être placées",
  未查到产品信息: "Aucune information produit trouvée",
  订单不存在: "L'ordre n'existe pas",
  "订单已支付，不可重复支付":
    "La commande a déjà été payée, le paiement en double n'est pas autorisé",
  ...
  "您尚未完成当天的订单数量，无法提现":
    "Vous n'avez pas complété le nombre de commandes pour aujourd'hui, le retrait n'est pas autorisé",
  团体: "Groupe",
  ...
  您尚未完成当天的申请数量:
    "Vous n'avez pas rempli le nombre de demandes pour la journée.",
  ...
  "地址未填写,请填写完整":
    "L'adresse n'est pas remplie, s'il vous plaît remplir complètement",
  ...
  您无法升级到低于当前级别的级别:
    "Vous ne pouvez pas passer à un niveau inférieur à votre niveau actuel",
  ...
  "已有提现订单,请勿重复申请":
    "Il y a déjà un ordre de retrait, s'il vous plaît ne pas demander à nouveau",
  "您尚未填写银行信息，请点击留言。":
    "Vous n'avez pas rempli vos informations bancaires, s'il vous plaît cliquez sur le tableau d'information.",
  这里: "ici",
  ...
  "数字格式错误，无法解析":
    "Le format de numéro est incorrect et ne peut pas être analysé",
  "访问过于频繁，请稍候再试":
  ...
  "已有提现订单,请勿重复申请":
    "Nous avons une commande en espèces. Ne répétez pas la demande.",
